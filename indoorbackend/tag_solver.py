            ...
            for j in range(len(DDoA)):
                ...
                if DDoA[i][j]!=0:
                    ...
                    + np.sqrt( (estimation[0]-anchor_locations[j][0])**2 + (estimation[1]-anchor_locations[j][1])**2 )-DDoA[i][j])
                        ...
                        # tag_locations.append(estimation[1]>0)
                        # tag_locations.append(estimation[1]<400)
...
# zero_coor = [[-1,-1]]
# beacon_pos = ""
# tag_solver(estimation,[DDoA,anchor_locations,zero_coor,beacon_pos])
