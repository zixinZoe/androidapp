...
//          Serial.println(same_init_count);
      ...
      {
//        Serial.println("pollthisRange[i].seq");
//        Serial.print(thisRange[i].seq);
...
//      Serial.println(loc_msg);
      ...
      for(int i=0;i<num_nodes;i++)
      {
        ...
        {
//          Serial.println("REspthisRange[i].device_ID");
//          Serial.print(thisRange[i].device_ID);
...
//          Serial.println("recvd_resp_seq");
//          Serial.print(recvd_resp_seq);
...
//          thisRange[i].RespRxTime_T = rxTS;
      ...
      Serial.println("respcurrentdeviceid");
...
//                Serial.println(j);
                ...
                char buff[200];
                //collect values here print outside double loop
                ids = ids+";"+anchor_locs[thisRange[i].device_ID];
                Serial.println("responder ids:");
                Serial.print(thisRange[i].device_ID);
//                Serial.println("responder locations:");
//                Serial.print(anchor_locs[thisRange[i].device_ID]);
