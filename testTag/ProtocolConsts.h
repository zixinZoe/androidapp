...
#define POLL_MSG_POLL_RESP_ORDER_IDX 13 //sets responder schedule
#define POLL_MSG_POLL_SELF_LOCATION_X 21 //broadcasts its own location
#define POLL_MSG_POLL_SELF_LOCATION_Y 25 //broadcasts its own location

#define FINAL_MSG_FINAL_TX_TS_IDX 6
#define FINAL_MSG_RESP_IDX 13
...
#define RESP_MSG_PREV_DB_IDX 13
#define RESP_MSG_PREV_RB_IDX 19
#define RESP_MSG_SELF_LOCATION_X 29 //broadcasts its own location
#define RESP_MSG_SELF_LOCATION_Y 33 //broadcasts its own location

//CIR
#define RESP_MSG_POLL_PW_IDX 24

#define POLL_MSG_RAND_BOUND_IDX 13
